...
db_url = os.getenv("DATABASE_URL", "postgresql://neuralops:neuralops@localhost:5432/neuralops")
...
def run_migrations_offline() -> None:
    ...
    here.  By specifying-strength we don't even need a DBAPI to be available.
